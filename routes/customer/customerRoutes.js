...
const { createCustomer, deleteCustomer } = require('../../controller/customers/createCustomer.js');
...
router.delete('/customer-details/:customerId',verifyToken, deleteCustomer);
